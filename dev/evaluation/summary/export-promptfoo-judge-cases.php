...
$input   = npcink_summary_judge_path( (string) ( $arg_map['input'] ?? 'dev/evaluation/summary/generated/muze-candidates.json' ), $root );
$output  = npcink_summary_judge_path( (string) ( $arg_map['output'] ?? 'dev/evaluation/summary/generated/promptfoo-judge-cases.csv' ), $root );
