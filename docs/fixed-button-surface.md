...
| --- | --- | --- | --- | --- | --- | --- |
| Adapt External Source | Editor Content Support | one public article URL plus optional editor direction | `source_adaptation_review.v1` | Cloud web-search reader, Cloud Site Knowledge vectors, and hosted suggestion runtime | human editor reviews and writes; native WordPress save only after manual editing | `default_button_v1`; no full translation, article-body generation/insertion, local URL fetch, media import, Core proposal, or publish |
