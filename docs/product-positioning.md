...
summary/category/tag optimization, internal-link candidates, and image
candidates, but it must keep the same suggestion-only and Core-governed write
posture as the admin surface.
