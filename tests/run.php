...
toolbox_assert( false !== strpos( $editor_js, 'metadataSectionHasSource' ) && false !== strpos( $editor_js, 'item && item.value' ) && false !== strpos( $editor_js, 'metadataHandoffHasChoices' ) && false !== strpos( $editor_js, 'npcink-toolbox-editor-support__metadata-handoff-body' ), 'Editor Content Support keeps summary-only runs focused on summary values and collapses Core handoff details.' );
toolbox_assert( false !== strpos( $editor_js, 'Evidence and diagnostics' ) && false !== strpos( $editor_js, 'Ranking and dedupe strategy' ) && false !== strpos( $editor_js, 'Review metrics' ), 'Editor Content Support folds precision layers, dedupe strategy, and review metrics into collapsible details.' );
