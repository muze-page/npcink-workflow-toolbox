...
toolbox_assert( false !== strpos( $editor_js, "imageMode === 'paragraph'" ) && false !== strpos( $editor_js, 'Import media for paragraph' ) && false !== strpos( $editor_js, "adoption_target: setFeaturedImage ? 'featured_image' : 'media_import'" ), 'Editor paragraph image mode defaults to media import instead of featured-image adoption.' );
