...
toolbox_assert( false !== strpos( $editor_js, 'imageResultSourceLabel' ) && false !== strpos( $editor_js, 'imageCandidateSourceLabel' ) && false !== strpos( $editor_js, 'hosted_profile' ) && false !== strpos( $editor_js, 'model_id' ), 'Editor image recommendation modal displays AI image source from hosted profile and model metadata.' );
