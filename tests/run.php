...
toolbox_assert( false !== strpos( $rest, "'hosted_ai'" ) && false !== strpos( $rest, "'hosted_profile' => 'text.ai'" ) && false !== strpos( $rest, "'posture'        => 'suggestion_only_core_approval_required'" ) && false === strpos( $rest, "'model_id'       =>" ), 'Status exposes model-neutral hosted AI metadata without adding write authority.' );
