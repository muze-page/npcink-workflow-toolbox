...
toolbox_assert( false !== strpos( $admin_page, 'Discoverability Brief' ) && false !== strpos( $admin_page, 'Publish Preflight' ) && false !== strpos( $admin_page, 'Summary and Terms Optimization' ) && false !== strpos( $admin_page, 'Existing Taxonomy/Tag Candidates' ) && false !== strpos( $admin_page, 'Internal Link Candidates' ) && false !== strpos( $admin_page, 'Image Candidates' ), 'Tool actions expose fixed Content Support flows as first-class buttons.' );
...
toolbox_assert( false !== strpos( $admin_page, 'name="context_scope"' ) && false !== strpos( $admin_page, 'Full article context' ) && false !== strpos( $admin_page, 'Topic or short brief only' ) && false !== strpos( $admin_page, 'Find existing terms' ), 'Admin Content Support lets operators scope article, selection, and topic-only recommendation context.' );
