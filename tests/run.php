...
toolbox_assert( false !== strpos( $editor_js, "initialSearchMode: 'generate'" ) && false !== strpos( $editor_js, "setImageSearchMode(initialSearchMode)" ) && false !== strpos( $editor_js, "activePicker.autoSearch && initialSearchMode !== 'generate'" ), 'Paragraph image toolbar opens directly into AI image mode without running a source search first.' );
